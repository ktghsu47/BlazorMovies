...
#nullable restore
#line 12 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesList.razor"
    ...
    private async Task DeleteMovie(Movie movie) {
        ...
        if (confirmed) {
            await iMovie.DeleteMovie(movie.Id);
            Movies.Remove(movie);
        }
    }
...
#line hidden
#nullable disable
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private IMovieRepository iMovie { get; set; }
