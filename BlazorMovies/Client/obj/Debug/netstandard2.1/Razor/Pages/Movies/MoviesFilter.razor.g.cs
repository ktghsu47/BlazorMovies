#pragma checksum "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7ba46480f0270b69cd6053101af41ed55e46daec"
// <auto-generated/>
...
#nullable restore
#line 8 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                 filterMoviesDTO
...
#nullable restore
#line 14 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable restore
#line 13 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable restore
#line 17 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable disable
                ...
                __builder2.CloseElement();
#nullable restore
#line 21 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable restore
#line 22 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                                    genre.Id
...
#nullable disable
                ...
                __builder2.CloseElement();
#nullable restore
#line 23 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                }
...
#nullable restore
#line 28 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable restore
#line 35 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
...
#nullable restore
#line 41 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                                                                             SearchForMovies
...
#nullable restore
#line 42 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                                                                    Clear
...
#nullable disable
            ...
            __builder.OpenComponent<BlazorMovies.Client.Shared.MovieList>(65);
            __builder.AddAttribute(66, "Movies", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<System.Collections.Generic.List<BlazorMovies.Shared.Entities.Movie>>(
#nullable restore
#line 46 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                   Movies
...
#nullable disable
            ...
            __builder.AddAttribute(69, "CurrentPage", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<System.Int32>(
#nullable restore
#line 48 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                         filterMoviesDTO.PageNumber

#line default
#line hidden
#nullable disable
            ));
            __builder.AddAttribute(70, "TotalAmountPages", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<System.Int32>(
#nullable restore
#line 48 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
                                                                       totalAmountPages
...
#nullable restore
#line 50 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Movies\MoviesFilter.razor"
    ...
    protected async override Task OnInitializedAsync() {
        var queryStrings = nav.GetQueryStrings(nav.Uri);
    ...
    private void FillFilterWithQueryStrings(Dictionary<string, string> queryStrings) {
        ...
        if (queryStrings.ContainsKey("pageNumber")) {
            filterMoviesDTO.PageNumber = int.Parse(queryStrings["pageNumber"]);
        }
    }

    private async Task SelectedPage(int pageNumber) {
        filterMoviesDTO.PageNumber = pageNumber;
        await LoadMovies();
    }
    ...
    private async Task LoadMovies() {
        ...
        var paginatedResponse = await repoMovie.GetMoviesFiltered(filterMoviesDTO);
        Movies = paginatedResponse.Response;
        totalAmountPages = paginatedResponse.PageTotal;
    }
    ...
    private string GenerateQueryString() {
        ...
        queryStringsDict["page"] = filterMoviesDTO.PageNumber.ToString();
