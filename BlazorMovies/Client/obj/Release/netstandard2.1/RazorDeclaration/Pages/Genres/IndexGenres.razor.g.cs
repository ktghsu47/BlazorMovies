...
#nullable disable
#nullable restore
#line 3 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Genres\IndexGenres.razor"
...
#nullable restore
#line 35 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Genres\IndexGenres.razor"
        
    List<Genre> Genres;

    protected override async Task OnInitializedAsync() {
        try {
            Genres = await repo.GetGenres();
        } catch (Exception ex) {
...
#line hidden
#nullable disable
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private IGenreRepository repo { get; set; }
    }
}
