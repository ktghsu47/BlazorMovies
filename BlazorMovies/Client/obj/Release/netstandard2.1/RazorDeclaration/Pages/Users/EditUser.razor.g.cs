...
#line 20 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Users\EditUser.razor"
    ...
    private async Task AssignRole() {
        ...
        await repo.AssignRole(new EditRoleDTO() { RoleName = selectedRole, UserId = UserId });
    ...
    private async Task RemoveRole() {
        ...
        await repo.RemoveRole(new EditRoleDTO() { RoleName = selectedRole, UserId = UserId });
...
#nullable disable
        ...
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private IUsersRepository repo { get; set; }
    }
}
