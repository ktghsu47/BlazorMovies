...
#line 29 "C:\My Documents\AppCodes\BlazorMovies\BlazorMovies\Client\Pages\Auth\Register.razor"
    ...
    private async Task RegisterUser() {
        var userToken = await repo.Register(userInfoDTO);
        await log.Login(userToken);
        nav.NavigateTo("");
    }
...
#line hidden
#nullable disable
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private ILoginService log { get; set; }
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private NavigationManager nav { get; set; }
        [global::Microsoft.AspNetCore.Components.InjectAttribute] private IAccountsRepository repo { get; set; }
    }
}
