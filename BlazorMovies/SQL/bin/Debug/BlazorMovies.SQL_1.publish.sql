/*
Deployment script for BlazorMovies
...
GO
:setvar DatabaseName "BlazorMovies"
:setvar DefaultFilePrefix "BlazorMovies"
...
GO
PRINT N'Creating [dbo].[MovieRatings]...';
...
GO
PRINT N'Creating [dbo].[MoviesActors]...';
...
GO
PRINT N'Creating [dbo].[MoviesGenres]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[MovieRatings]...';


GO
ALTER TABLE [dbo].[MovieRatings]
    ADD DEFAULT GETDATE() FOR [RatingDate];
...
GO
ALTER TABLE [dbo].[Movies]
    ADD DEFAULT GETDATE() FOR [ReleaseDate];


GO
PRINT N'Creating [dbo].[spGenres_All]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a09dc398-f198-4a86-8b4e-29eb1637b139')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a09dc398-f198-4a86-8b4e-29eb1637b139')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '08ae5162-a9cc-466a-93bc-394dc40218ff')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('08ae5162-a9cc-466a-93bc-394dc40218ff')
